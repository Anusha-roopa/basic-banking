...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px blue;">ANUSHA H</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br>CMR Institute of Technology,Bangalore<br>email-anushah2105@gmail.com</b></p>
    </center>
